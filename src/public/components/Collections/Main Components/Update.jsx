                        ...
                        <div>
                            ...
                            {this.state.mobile === true ?
                                <div className="mobile-warning">
                                    WARNING: If you wish to edit the description of your lesson or of your photos, please use a PC or laptop. You can still edit the lesson with all the other details. We're sorry for the inconvenience
                                </div>
                                :
                                null
                            }

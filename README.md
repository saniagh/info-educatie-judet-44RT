...
<li>Favourite somebody's collection</li>
...
<li>Socket.io is used for the comments system. This way, we provide real-time comments for every single collection on the website, separately, of course. Same for the favourite system.</li>
